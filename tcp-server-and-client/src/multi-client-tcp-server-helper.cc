...
void
MultiClientTcpServerHelper::SetAttribute (std::string name, const AttributeValue &value)
{
  m_factory.Set (name, value);
}

ApplicationContainer
MultiClientTcpServerHelper::Install (Ptr<Node> node) const
{
  return ApplicationContainer (InstallPriv (node));
}

ApplicationContainer
MultiClientTcpServerHelper::Install (std::string nodeName) const
{
...
ApplicationContainer
MultiClientTcpServerHelper::Install (NodeContainer c) const
{
...
Ptr<Application>
MultiClientTcpServerHelper::InstallPriv (Ptr<Node> node) const
{
