...
/**
 * \brief A TCP client created from the modified version of the udp echo client.
 * The client creates a TCP connection with a server and sends packets to it.
 * This application was created to work with TcpServer and can be used generally as well.
 */
